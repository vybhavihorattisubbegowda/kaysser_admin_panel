...
<head>
    ...
    <title>Admin Panel-Stundensummen</title>
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="month" role="tabpanel" aria-labelledby="month-tab">
                                ...
                                <div class="card mb-4">
                                    <div class="card-header">
                                        ...
                                        Tägliche Arbeitsstunden sind aussummiert!
                                    </div>
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table table-bordered" id="dataTable1" width="100%" cellspacing="0">
                                                ...
                                                <tbody>
                                                    ...
                                                    $monthly_hours = file_get_contents('http://127.0.0.1:8000/attendance/summary/monthly');
                            ...
                            <div class="tab-pane fade" id="week" role="tabpanel" aria-labelledby="week-tab">
                                ...
                                <div class="card mb-4">
                                    <div class="card-header">
                                        <i class="fas fa-table mr-1"></i>
                                        Tägliche Arbeitsstunden Berechnet mit 1St. :100!
                                    </div>
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table table-bordered" id="dataTable2" width="100%" cellspacing="0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php
                                                    //URL contains SQL result of Combined tables like Mitarbeiter, Attendance,Timesheet
                                                    $weekly_hours = file_get_contents('http://127.0.0.1:8000/attendance/summary/weekly');
                                                    //Array with Objects instead Arrays
